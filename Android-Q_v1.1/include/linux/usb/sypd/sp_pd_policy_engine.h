...
/******************* DR_SWAP *******************/
#ifdef CONFIG_USB_PD_DR_SWAP
void pe_drs_dfp_ufp_evaluate_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_dfp_ufp_accept_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_dfp_ufp_change_to_ufp_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_dfp_ufp_send_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_dfp_ufp_reject_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_ufp_dfp_evaluate_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_ufp_dfp_accept_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_ufp_dfp_change_to_dfp_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_ufp_dfp_send_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_drs_ufp_dfp_reject_dr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
#endif	/* CONFIG_USB_PD_DR_SWAP */
/******************* PR_SWAP *******************/
#ifdef CONFIG_USB_PD_PR_SWAP
void pe_prs_src_snk_evaluate_pr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_accept_pr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_transition_to_off_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_assert_rd_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_wait_source_on_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_wait_source_on_exit(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_send_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_src_snk_reject_pr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_evaluate_pr_swap_entry(struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_accept_pr_swap_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_transition_to_off_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_transition_to_off_exit( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_assert_rp_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_source_on_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_source_on_exit( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_send_swap_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_prs_snk_src_reject_swap_entry( struct pd_port *pd_port, struct pd_event *pd_event);
/* get same role cap */
...
void pe_vcs_evaluate_swap_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_accept_swap_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_reject_vconn_swap_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_wait_for_vconn_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_wait_for_vconn_exit( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_turn_off_vconn_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_turn_on_vconn_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_vcs_send_ps_rdy_entry( struct pd_port *pd_port, struct pd_event *pd_event);
#endif	/* CONFIG_USB_PD_VCONN_SWAP */
/******************* UFP_VDM *******************/
void pe_ufp_vdm_get_identity_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_send_identity_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_get_identity_nak_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_get_svids_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_send_svids_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_get_svids_nak_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_get_modes_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_send_modes_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_get_modes_nak_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_evaluate_mode_entry_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_mode_entry_ack_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_mode_entry_nak_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_mode_exit_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_mode_exit_ack_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_mode_exit_nak_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_attention_request_entry( struct pd_port *pd_port, struct pd_event *pd_event);
#ifdef CONFIG_USB_PD_ALT_MODE
void pe_ufp_vdm_dp_status_update_entry( struct pd_port *pd_port, struct pd_event *pd_event);
void pe_ufp_vdm_dp_configure_entry( struct pd_port *pd_port, struct pd_event *pd_event);
#endif/* CONFIG_USB_PD_ALT_MODE */
/******************* DFP_VDM *******************/
...
#endif	/* CONFIG_USB_PD_REV30_PPS_SINK */
#ifdef CONFIG_USB_PD_REV30_PPS_SOURCE
void pe_src_give_pps_status_entry( struct pd_port *pd_port, struct pd_event *pd_event);
#endif	/* CONFIG_USB_PD_REV30_PPS_SOURCE */
#endif /* CONFIG_USB_PD_REV30 */
/******************* Others *******************/
#ifdef CONFIG_USB_PD_CUSTOM_DBGACC
