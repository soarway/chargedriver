...
enum syba76_bc_fields {
	DEVICE_ID,				     		/* Reg00 */
	VAC_OVP_DIS, VAC_OVP, VBUS_OVP_DIS, VBUS_OVP,	/* Reg04 */
	TSBUS_FLT,/* Reg05 */
	TSBAT_FLT,/* Reg06 */
	ACDRV_EN, ACDRV_MANUAL_EN, WD_TIMER_RST, WD_TIMEOUT, /* Reg07 */
	REG_RST, VBUS_PD, VAC_PD, PMID_PD_EN, TSHUT_DIS, TSBUS_TSBAT_FLT_DIS,/* Reg08 */
	ADC_DONE_STAT, REGN_OK_STAT, VBAT_PRESENT_STAT,VBUS_PRESENT_STAT,VAC_PRESENT_STAT,/* Reg09 */
	POR_FLG, RESET_FLG, ADC_DONE_FLG, REGN_OK_FLG, VBAT_PRESENT_FLG, VBUS_PRESENT_FLG, VAC_PRESENT_FLG,/* Reg0A */
	POR_MASK, RESET_MASK, ADC_DONE_MASK, REGN_OK_MASK, VBAT_PRESENT_MASK, VBUS_PRESENT_MASK, VAC_PRESENT_MASK,/* Reg0B */
	TSHUT_STAT, TSBAT_HOT_STAT, TSBAT_COLD_STAT,TSBUS_FLT_STAT, VBUS_OVP_STAT, VAC_OVP_STAT,/* Reg0C */
	WD_TIMEOUT_FLG, TSHUT_FLG, TSBAT_HOT_FLG, TSBUS_FLT_FLG, VBUS_OVP_FLG, VAC_OVP_FLG,/* Reg0D */
	WD_TIMEOUT_MASK, TSHUT_MASK, TSBAT_HOT_MASK, TSBAT_COLD_MASK, TSBUS_FLT_MASK, VBUS_OVP_MASK, VAC_OVP_MASK,/* Reg0E */
	ADC_EN, ADC_RATE, BATID_ADC_EN, IBUS_ADC_DIS, VBUS_ADC_DIS, VAC_ADC_DIS,/* Reg0F */
	VBATSNS_ADC_DIS, VBAT_ADC_DIS, IBAT_ADC_DIS,VSYS_ADC_DIS, TSBUS_ADC_DIS, TSBAT_ADC_DIS, TDIE_ADC_DIS,/* Reg10 */
	IBUS_ADC_1,/* Reg11 */
	IBUS_ADC_2,/* Reg12 */
	VBUS_ADC_1,/* Reg13 */
	VBUS_ADC_2,/* Reg14 */
	...
	BATID_ADC_2,/* Reg26 */
	SYS_MIN,/* Reg30 */
	BATSNS_EN,VBAT_REG,/* Reg31 */
	ICHG_CC,/* Reg32 */
	VINDPM_VBAT,VINDPM_DIS,VINDPM,/* Reg33 */
	IINDPM_DIS,IINDPM,/* Reg34 */
	FORCE_ICO,ICO_EN,IINDPM_ICO,/* Reg35 */
	VBAT_PRECHG,IPRECHG,/* Reg36 */
	TERM_EN,ITERM_LSB_SET,ITERM,/* Reg37 */
	RECHG_DIS,RECHG_DG,VRECHG,/* Reg38 */
	VBOOST,IBOOST_LIM,/* Reg39 */
	CONV_OCP_DIS,TSBAT_JEITA_DIS,IBAT_OCP_DIS,VPMID_OVP_OTG_DIS,VBAT_OVP_BUCK_DIS,/* Reg3A */
	T_BATFET_RST,BATFET_RST_EN,BATFET_DLY,BATFET_DIS,/* Reg3B */
	HIZ_EN,DIS_BUCK_PATH,QB_EN,BOOST_EN,CHG_EN,/* Reg3C */
	VBAT_TRACK,IBATOCP,VSYSOVP_DIS,VSYSOVP_TH,/* Reg3D */
	BAT_COMP,VCLAMP,JEITA_ISET_COOL,JEITA_VSET_WARM,/* Reg3E */
	TMR2X_EN,CHG_TIMER_EN,CHG_TIMER,TDIE_REG_DIS,TDIE_REG,PFM_DIS,/* Reg3F */
	VBAT_LOW_OTG,BOOST_FREQ,BUCK_FREQ,BAT_LOAD_EN,/* Reg40 */
	VSYS_SHORT_STAT,VSLEEP_BUCK_STAT,VBAT_DPL_STAT,VBAT_LOW_BOOST_STAT,VBUS_GOOD_STAT,/* Reg41 */
	CHG_STAT,BOOST_OK_STAT,VSYSMIN_REG_STAT,QB_ON_STAT,BATFET_STAT,/* Reg42 */
	TDIE_REG_STAT,TSBAT_COOL_STAT,TSBAT_WARM_STAT,ICO_STAT,IINDPM_STAT,VINDPM_STAT,/* Reg43 */
	VSYS_SHORT_FLG,VSLEEP_BUCK_FLG,VBAT_DPL_FLG,VBAT_LOW_BOOST_FLG,VBUS_GOOD_FLG,/* Reg44 */
	CHG_FLG,BOOST_OK_FLG,VSYSMIN_REG_FLG,QB_ON_FLG,BATFET_FLG,/* Reg45 */
	TDIE_REG_FLG,TSBAT_COOL_FLG,TSBAT_WARM_FLG,ICO_FLG,IINDPM_FLG,VINDPM_FLG,/* Reg46 */
	VSYS_SHORT_MASK,VSLEEP_BUCK_MASK,VBAT_DPL_MASK,VBAT_LOW_BOOST_MASK,VBUS_GOOD_MASK,/* Reg47 */
	CHG_MASK,BOOST_OK_MASK,VSYSMIN_REG_MASK,QB_ON_MASK,BATFET_MASK,/* Reg48 */
	TDIE_REG_MASK,TSBAT_COOL_MASK,TSBAT_WARM_MASK,ICO_MASK,IINDPM_MASK,VINDPM_MASK,/* Reg49 */
	CONV_OCP_STAT,VSYS_OVP_STAT,IBUS_RCP_STAT,IBAT_OCP_STAT,VBAT_OVP_BUCK_STAT,/* Reg50 */
	OTG_HICCUP_STAT,CHG_TIMEOUT_STAT,VPMID_SHORT_STAT,VPMID_OVP_OTG_STAT,/* Reg51 */
	CONV_OCP_FLG,VSYS_OVP_FLG,IBUS_RCP_FLG,IBAT_OCP_FLG,VBAT_OVP_BUCK_FLG,/* Reg52 */
	OTG_HICCUP_FLG,CHG_TIMEOUT_FLG,VPMID_SHORT_FLAG,VPMID_OVP_OTG_FLG,/* Reg53 */
	CONV_OCP_MASK,VSYS_OVP_MASK,IBUS_RCP_MASK,IBAT_OCP_MASK,VBAT_OVP_BUCK_MASK,/* Reg54 */
	OTG_HICCUP_MASK,CHG_TIMEOUT_MASK,VPMID_SHORT_MASK,VPMID_OVP_OTG_MASK,/* Reg55 */
	JEITA_COOL_TEMP,JEITA_WARM_TEMP,BOOST_NTC_HOT_TEMP,JEITA_COLD_TEMP,BOOST_NTC_COLD_TEMP,/* Reg56 */
	EN_PUMPX,Higher_OCP_BOOST,/* Reg57 */
	PUMPX_UP,PUMPX_DN,VDR_OVP_DEGLITCH,VDR_OVP_THRESHOLD,/* Reg58 */
	FLED1_EN,FLED2_EN,TLED1_EN,TLED2_EN,FL_TX_EN,TRPT,/* Reg80 */
	FLED1_BR,/* Reg81 */
	FLED2_BR,/* Reg82 */
	FTIMEOUT_EN,FRPT,FTIMEOUT,/* Reg83 */
	TLED1,/* Reg84 */
	TLED2,/* Reg85 */
	LED_POWER,VBAT_MIN_FLED_DEG,VBAT_MIN_FLED,PMID_FLED_OVP_DEG,/* Reg86 */
	FLED1_STAT,FLED2_STAT,TLED1_STAT,TLED2_STAT,/* Reg87 */
	FTIMIEOUT1_STAT,FTIMIEOUT2_STAT,PMID_FLED_OVP_STAT,LED1_SHORT_STAT,LED2_SHORT_STAT,PTORCH_UVP_STAT,PTORCH_OVP_STAT,VBAT_LED_LOW_STAT,/* Reg88 */
	FTIMIEOUT1_FLG,FTIMIEOUT2_FLG,PMID_FLED_OVP_FLG,LED1_SHORT_FLG,LED2_SHORT_FLG,PTORCH_UVP_FLG,PTORCH_OVP_FLG,VBAT_LED_LOW_FLG, /* Reg89 */
	FTIMIEOUT1_MASK,FTIMIEOUT2_MASK,PMID_FLED_OVP_MASK,LED1_SHORT_MASK,LED2_SHORT_MASK,PTORCH_UVP_MASK,PTORCH_OVP_MASK,VBAT_LED_LOW_MASK,/* Reg8A */
	FL_TX_STAT,FL_TX_FLG,FL_TX_MASK,/* Reg8B */
	FORCE_INDET,AUTO_INDET_EN,HVDCP_EN,FC_EN,/* Reg90 */
	DP_DRIVE,DM_DRIVE,/* Reg91 */
	QC35_2PLUS_2MINUS,QC35_3PLUS_MINUS,QC35_16_MINUS,QC35_16_PLUS,FC3_MINUS,FC3_PLUS,FC2,/* Reg92 */
	VBUS_STAT,INPUT_DET_DONE_FLAG,DP_OVP_FLAG,DM_OVP_FLAG,/* Reg94 */
	INPUT_DET_DONE_MASK,DP_OVP_MASK,DM_OVP_MASK,/* Reg95 */
